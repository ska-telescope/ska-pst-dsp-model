function hdr_map = read_header(file_id)
  ...
  % @method read_header
  % @param {double} file_id - The file id generated by fopen
  % @param {containers.Map} map - an instance of containers.Map
  % @return {containers.Map} - map object containing header information
  %   from file
